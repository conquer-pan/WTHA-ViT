...
model = dict(
    type='ATSS',
    pretrained='/home/omeneis/pjh/mmdetection-2.26.0/work_COCO/atss/epoch_12.pth',
    backbone=dict(
        # type='WTHA_ViT_s',
        _delete_=True,
        type='WTHA_ViT_s_network2',
        init_cfg=dict(type='Pretrained', checkpoint='/home/omeneis/pjh/mmdetection-2.26.0/work_COCO/atss/epoch_12.pth'),
        style='pytorch'),
    neck=dict(
        type='FPN',
