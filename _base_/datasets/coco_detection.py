...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        # ann_file=data_root + 'annotations/instances_train2017.json', #coco
        ...
        img_prefix=[data_root + 'train1024/images', '/home/omeneis/pjh/dataset/dota_cut/dota1-split-1024_gap400/train1024_multi/images'], #dota
        # ann_file=data_root + 'annotations/train2017.json',#HRSID
        # img_prefix=data_root + 'images',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        # ann_file=data_root + 'annotations/instances_val2017.json', #coco
        # img_prefix=data_root + 'val2017/',
        ann_file=data_root + 'val1024/DOTA_val1024_remove.json',
        img_prefix=data_root + 'val1024/images', #dota
    ...
    test=dict(
        ...
        # ann_file=data_root + 'annotations/instances_val2017.json', #coco
        # img_prefix=data_root + 'val2017/',
        ann_file=data_root + 'val1024/DOTA_val1024_remove.json', #dota
