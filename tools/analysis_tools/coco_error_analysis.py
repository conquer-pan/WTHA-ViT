...
def makeplot(rs, ps, outDir, class_name, iou_type):
    ...
    cs = np.vstack([
        np.ones((1, 3)),
        np.array([0.69, 0.88, 0.90]),
        np.array([0.60, 0.80, 0.20]),
        np.array([0.545, 0.514, 0.902]),
        np.array([0.39, 0.72, 1]),
        np.array([1, 0.87, 0.68]),
        # np.array([0.804, 0.361, 0.361]),
        np.array([0.98, 0.502, 0.447]),
    ])
