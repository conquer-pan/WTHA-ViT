...
class UniFormer(nn.Module):
    ...
    """
    def __init__(self, layers=[3, 4, 8, 3], img_size=224, in_chans=3, num_classes=1, embed_dim=[64, 128, 320, 512],
                 head_dim=64, mlp_ratio=4., qkv_bias=True, qk_scale=None, representation_size=None,
                 drop_rate=0., attn_drop_rate=0.2, drop_path_rate=0., norm_layer=partial(nn.LayerNorm, eps=1e-6),
                 use_checkpoint=False, checkpoint_num=[0, 0, 0, 0], 
                 windows=False, hybrid=False, window_size=14, init_cfg=dict(type='Pretrained', checkpoint=None),):
        """
        Args:
