...
class SpectFormer(nn.Module):
    def __init__(self, 
        ...
        **kwargs
        ...
        if self.return_dense: #转换到class数
...
class spectformer_s(SpectFormer):
    def __init__(self, **kwargs):
        super(spectformer_s, self).__init__(
            stem_hidden_dim = 32,
            embed_dims = [64, 128, 320, 448], 
            num_heads = [2, 4, 10, 14], 
            mlp_ratios = [8, 8, 4, 4],
...
# @register_model
@BACKBONES.register_module()
class spectformer_b(SpectFormer):
    def __init__(self, **kwargs):
        super(spectformer_b, self).__init__(
            stem_hidden_dim = 64,
...
# @register_model
@BACKBONES.register_module()
class spectformer_l(SpectFormer):
    def __init__(self, **kwargs):
        super(spectformer_l, self).__init__(
            stem_hidden_dim = 64,
