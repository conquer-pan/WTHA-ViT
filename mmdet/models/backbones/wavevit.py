...
class wavevit_s(WaveViT):
    def __init__(self, **kwargs):
        super(wavevit_s, self).__init__(
            stem_width=32,
            embed_dims=[64, 128, 320, 448],
            num_heads=[2, 4, 10, 14],
            mlp_ratios=[8, 8, 4, 4],
...
@BACKBONES.register_module()
class wavevit_b(WaveViT):
    def __init__(self, **kwargs):
        super(wavevit_b, self).__init__(
            stem_width=64,
...
@BACKBONES.register_module()
class wavevit_l(WaveViT):
    def __init__(self, **kwargs):
        super(wavevit_l, self).__init__(
            stem_width=64,
